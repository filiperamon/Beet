...
//					Intent intent = new Intent(this, typeof(SplashActivity.GPSServiceReciever));  
//					intent.SetAction(SplashActivity.GPSServiceReciever.LOCATION_UPDATED);  
//					intent.AddCategory(Intent.CategoryDefault);  
//					intent.PutExtra("CountryCode", addressCurrent.CountryCode);   

//					AppPreferences ap = new AppPreferences (Android.App.Application.Context);
//					ap.saveKey (AppPreferences.LOCALE_USER, addressCurrent.CountryCode);
